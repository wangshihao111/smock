...
import { isArray, isObject, cloneDeep, isEqual } from 'lodash';
...
export class MockUtil {
   ...
   * @param path 
   */
  public static readLocalFile(path: string): [Map<string, MockFileContent>, Map<string, JsDefinition>] {
   ...
   */
  public static validateParams(apiType, obj, isQuery: boolean = false): boolean {
